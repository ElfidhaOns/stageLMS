...
$profile_data = array(
	array( __( 'Date d\'inscription', 'tutor' ), ( $rdate ? tutor_i18n_get_formated_date( tutor_utils()->get_local_time_from_unix( $rdate ) ) : '' ) ),
	array( __( 'Prénom', 'tutor' ), ( $fname ? $fname : esc_html( '-' ) ) ),
	array( __( 'Nom', 'tutor' ), ( $lname ? $lname : '-' ) ),
	array( __( 'Nom d\'utilisateur', 'tutor' ), $uname ),
	array( __( 'Email', 'tutor' ), $email ),
	array( __( 'Numéro de téléphone', 'tutor' ), ( $phone ? $phone : '-' ) ),
	array( __( 'Compétence / Profession', 'tutor' ), ( $job ? $job : '-' ) ),
	array( __( 'Biographie', 'tutor' ), $bio ? $bio : '-' ),
);
?>

<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24"><?php esc_html_e( 'Mon Profil', 'tutor' ); ?></div>
