<?php
/**
 * Template pour afficher les paramètres
 *
...
$setting_menus = array(
	'profile'        => array(
		...
		'title' => __( 'Profil', 'tutor' ),
		'role'  => false,
	),
	'reset_password' => array(
		'url'   => esc_url( $reset_password ),
		'title' => __( 'Mot de passe', 'tutor' ),
		'role'  => false,
	),
	'withdrawal'     => array(
		'url'   => esc_url( $withdraw ),
		'title' => __( 'Retrait', 'tutor' ),
		'role'  => 'instructor',
	),
	'social-profile' => array(
		'url'   => esc_url( $social ),
		'title' => __( 'Profil social', 'tutor' ),
		'role'  => false,
	),
);
...
<ul class="tutor-nav" tutor-priority-nav>
	<?php foreach ( $setting_menus as $menu_key => $menu ) : ?>
		...
		<?php if ( $valid ) : ?>
			<li class="tutor-nav-item">
				<a class="tutor-nav-link<?php echo $active_setting_nav == $menu_key ? ' is-active' : ''; ?>" href="<?php echo esc_url( $menu['url'] ); ?>">
	...
	<li class="tutor-nav-item tutor-nav-more tutor-d-none">
		<a class="tutor-nav-link tutor-nav-more-item" href="#"><span class="tutor-mr-4"><?php esc_html_e( 'Plus', 'tutor' ); ?></span> <span class="tutor-nav-more-icon tutor-icon-times"></span></a>
