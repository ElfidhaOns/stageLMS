 ...
 * Slug: blockskit-online-education/template-single-product
 * Categories: template
 * Inserter: false
 */
...
<h1 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Single Product', 'blockskit-online-education' ); ?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'Related products', 'blockskit-online-education' ); ?></h2>
<!-- /wp:heading -->
