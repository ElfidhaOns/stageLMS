<?php
 /**
  * Title: Template 404
  * Slug: blockskit-online-education/template-404
  * Categories: template
  * Inserter: false
  */
...
<!-- wp:cover {"url":"<?php echo esc_url($blockskit_online_education_images[0]); ?>","id":79,"dimRatio":80,"overlayColor":"foreground","focalPoint":{"x":0.5,"y":0},"minHeight":700,"style":{"spacing":{"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large"}}}} -->
...
<p class="has-text-align-center"><?php esc_html_e( 'This page could not be found. Maybe try a search?', 'blockskit-online-education' ); ?></p>
<!-- /wp:paragraph -->
