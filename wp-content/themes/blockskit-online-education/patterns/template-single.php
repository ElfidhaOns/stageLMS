 ...
 * Slug: blockskit-online-education/template-single
 * Categories: template
 * Inserter: false
 */
...
<!-- wp:cover {"url":"<?php echo esc_url($blockskit_online_education_images[0]); ?>","id":79,"dimRatio":80,"overlayColor":"foreground","minHeight":480,"align":"full","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|large"},"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large"}}},"layout":{"type":"constrained"}} -->
